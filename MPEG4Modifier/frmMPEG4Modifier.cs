...
namespace JDP {
	partial class frmMPEG4Modifier : Form {
		...
		private void btnAbout_Click(object sender, EventArgs e) {
			MessageBox.Show(this, String.Format("MPEG4 Modifier v1.4.5{0}" +
				"Copyright 2004-2012 J.D. Purcell{0}http://www.moitah.net/", Environment.NewLine),
